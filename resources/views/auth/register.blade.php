                            ...
                            <div class="card">
                                ...
                                <form action="{{route('register')}}" method="POST">
                                    @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="username" id="username" placeholder="Enter Unique Username here" required>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control" name="password_confirmation" id="re-password" placeholder="Re-Type Password" required>
                                        </div>

    ...
    <div class="sidebar">
        ...
        <div class="logobar">
            <a href="{{ route('home') }}" class="logo logo-large"><img
                    src="{{ asset('assets/images/logo-wide.png') }}" class="img-fluid" alt="logo"></a>
            <a href="{{ route('home') }}" class="logo logo-small"><img
                    src="{{ asset('assets/images/logo-mobile.png') }}" class="img-fluid" alt="logo"></a>
        </div>

        <!-- Start Navigationbar -->
        <div class="navigationbar">
            <ul class="vertical-menu">
                @include('layouts.leftbar.nav-link',['icon'=>asset('assets/images/svg-icon/dashboard.svg'),'label'=>'Dashboard','route'=>route('home')])
                @auth
                    @if (Auth::user()->hasRole('super admin'))
                        @canany(['company_view', 'company_edit', 'company_create', 'company_delete'])
                            @include('layouts.leftbar.dropdown-nav-link',['label'=>'Company','icon'=>asset('assets/images/svg-icon/basic.svg'),
                            'subroutes'=>[
                        ...
                        @canany(['user_creation_page', 'user_view'])
                            ...
                            ['label'=>'User','icon'=>asset('assets/images/svg-icon/user.svg'),
                            'subroutes'=>[
                    ...
                    @else
                        @canany(['user_creation_page', 'user_view'])
                            @include('layouts.leftbar.dropdown-nav-link',
                            ['label'=>'Employee','icon'=>asset('assets/images/svg-icon/user.svg'),
                            'subroutes'=>[
                        ...
                        @canany(['site_create', 'site_view', 'site_edit', 'site_delete'])
                            @include('layouts.leftbar.dropdown-nav-link',
                            ['label'=>'Site','icon'=>asset('assets/images/svg-icon/ecommerce.svg'),
                            'subroutes'=>[
                        ...
                        @canany(['report_create', 'report_view', 'report_edit', 'report_create'])
                            @include('layouts.leftbar.dropdown-nav-link',
                            ['label'=>'Report','icon'=>asset('assets/images/svg-icon/form_elements.svg'),
                            'subroutes'=>[
                        ...
                        @endcanany
                         @canany(['setting_view', 'setting_edit'])
                                @include('layouts.leftbar.nav-link',['iconClass'=>'dripicons-gear','permissions'=>['setting_view','setting_edit'],'label'=>'Settings','route'=>route('settings.index')])
                        @endcanany
                    @endif

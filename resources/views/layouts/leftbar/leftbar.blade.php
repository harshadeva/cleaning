            ...
            <ul class="vertical-menu">
                ...
                @auth
                    @canany(['company_view', 'company_edit', 'company_create', 'company_delete'])
                        ...
                        'subroutes'=>[
                        ['permissions'=>['company_create'],'label'=>'Create','route'=>route('company.create')],
                        ['permissions'=>['company_view','company_delete','company_edit'],'label'=>'View','route'=>route('company.index')]
                        ]
                        ])
                    @endcanany
